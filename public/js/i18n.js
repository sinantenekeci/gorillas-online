...
(function (global) {
  ...
  var DICT = {
    tr: {
      ...
      "ctl.hintDrag": "Sahnede nereyi işaret edersen muz oraya doğru gider: dokunup sürükle.",
      "room.panel": "PANEL",
      ...
      "ctl.speed": "HIZ",
      "ctl.fire": "MUZU AT",
      "ctl.hintA": "Sahnede nişan al ya da kaydırıcıları sürükle,",
      "ctl.hintB": "ile at. Noktalar çıkış yönünü gösterir.",
    ...
    en: {
      ...
      "ctl.hintDrag": "Point anywhere in the arena and the banana heads that way: press and drag.",
      "room.panel": "PANEL",
      ...
      "ctl.hintA": "Aim on the arena or drag the sliders, press",
      "ctl.hintB": "to throw. Dots show the launch direction.",
