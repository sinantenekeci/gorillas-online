...
(function (global) {
  ...
  var DICT = {
    tr: {
      ...
      "ctl.hintDrag": "Sahnede yukarı-aşağı sürükle açıyı, sağa-sola sürükle hızı değiştirir.",
      "room.panel": "MENÜ",
      ...
      "ctl.speed": "HIZ",
      "ctl.fire": "MUZU AT",
      "ctl.hintA": "Sahnede sürükle: yukarı-aşağı açı, sağa-sola hız.",
      "ctl.hintB": "ile at.",
    ...
    en: {
      ...
      "ctl.hintDrag": "Drag up-down on the arena to change angle, left-right to change power.",
      "room.panel": "MENU",
      ...
      "ctl.hintA": "Drag on the arena: up-down angle, left-right power.",
      "ctl.hintB": "to throw.",
